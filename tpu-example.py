...
def main():
    ...
    parser.add_argument(
        "--max_new_tokens", type=int, default=512, help="Number of tokens to generate"
    )
    parser.add_argument(
        "--max_cache_length",
        type=int,
        default=256,
        help="Maximum cache length for the model",
    )
    ...
    for i in range(max_new_tokens):
        ...
        next_token = decode_one_tokens(
            model, next_token.clone(), pos_ids, cache_position, past_key_values
        )
        cache_position += 1
